<?php
/* Smarty version 3.1.34-dev-7, created on 2020-10-09 00:07:55
  from 'C:\xampp\htdocs\Shelby\templates\cervezas.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f7f8dbb1b9ea5_25383664',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd956172c41e5de4eaad5ba84794be910ff0c9204' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Shelby\\templates\\cervezas.tpl',
      1 => 1601653375,
      2 => 'file',
    ),
  ),
...
function content_5f7f8dbb1b9ea5_25383664 (Smarty_Internal_Template $_smarty_tpl) {
?><article id="menu-cervezas">
        <ul class="lista-cerveza">
            ...
            <li class="li-cerveza"><a href="#descripcion">Descripción</a></li>
        </ul>
        <div class="menu-cerveza"><a href="#">Menú Cervezas</a></div>
    </article>
    
<article class="contenedor-cervezas">

        <div class="fotos-cervezas">

            <section class="cerveza">
                <figure class="img-cervezas">
                    <img src="imagenes/honey.png" alt="">
                </figure>
                <div id="honey"class="detalle-cerveza">
                    <p> <span> Honey</span> 
                        Cerveza dorada elaborada con el agregado de la mejor miel selecta de la
            ...
            <section class="cerveza">
                ...
                <div id="red"class="detalle-cerveza">
                    <p><span> Red</span> 
                        Cerveza de color rubí y cuerpo medio, con un toque de elegantes
            ...
            <section class="cerveza">
                ...
                <div id="porter"class="detalle-cerveza">
                    <p><span>Porter</span>  Cerveza de origen inglés, de color amarronado y buen cuerpo. De
            ...
            <section class="cerveza">
                ...
                <div id="barleywine" class="detalle-cerveza">
                    <p><span>Barley Wine</span>Cerveza fuerte, alicorada, vinosa, color cobrizo claro a
            ...
            <section class="cerveza">
                ...
                <div id="ipa" class="detalle-cerveza">
                    <p><span> Ipa</span>La India Pale Ale es una cerveza fuerte de color ámbar con un
            ...
            <section class="cerveza">
                ...
                <div id="stout" class="detalle-cerveza">
                    <p><span>Stout </span>Las Stout son cervezas muy oscuras, prácticamente de color
            ...
            <section class="cerveza">
                ...
                <div id="pilsenlager" class="detalle-cerveza">
                    <p><span>Pilsen Lager</span>Las cervezas Pilsen son un tipo de cerveza muy
